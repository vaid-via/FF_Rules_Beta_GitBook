...
### Система санкций и предупреждений
...
**За нарушение любого пункта** участник получает [<mark style="color:red;">**предупреждение**</mark>](https://rules.foxford-community.ru/students#what-is-warn).&#x20;
...
* **Нарушение любого пункта** — предупреждение и временный [<mark style="color:red;">**мут на 7 дней**</mark>](https://rules.foxford-community.ru/students#what-is-mute). Пять предупреждений приводят к [<mark style="color:red;">**перманентному бану**</mark>](https://rules.foxford-community.ru/students#what-is-ban).
...
{% stepper %}
{% step %}
#### **Первое нарушение** <a href="#rule-2-restrictions-profile-warn-1" id="rule-2-restrictions-profile-warn-1"></a>
...
{% step %}
#### **Второе нарушение** <a href="#rule-2-restrictions-profile-warn-2" id="rule-2-restrictions-profile-warn-2"></a>
...
{% step %}
#### **Третье нарушение** <a href="#rule-2-restrictions-profile-warn-3" id="rule-2-restrictions-profile-warn-3"></a>
...
{% step %}
#### Перманентная блокировка <a href="#rule-2-restrictions-profile-ban" id="rule-2-restrictions-profile-ban"></a>
...
{% stepper %}
{% step %}
#### **Первое нарушение** <a href="#rule-2-restrictions-political-warn-1" id="rule-2-restrictions-political-warn-1"></a>

Предупреждение и [<mark style="color:red;">**мут на 2 недели**</mark>](https://rules.foxford-community.ru/students#what-is-mute).
{% endstep %}

{% step %}
#### **Повторное нарушение** <a href="#rule-2-restrictions-political-warn-2" id="rule-2-restrictions-political-warn-2"></a>
...
{% step %}
#### **Третье нарушение** <a href="#rule-2-restrictions-political-ban" id="rule-2-restrictions-political-ban"></a>
...
{% stepper %}
{% step %}
#### **Первое нарушение** <a href="#rule-4-restrictions-profile-warn-1" id="rule-4-restrictions-profile-warn-1"></a>
...
{% step %}
#### **Второе нарушение** <a href="#rule-4-restrictions-profile-warn-2" id="rule-4-restrictions-profile-warn-2"></a>
...
{% step %}
#### **Третье нарушение** <a href="#rule-4-restrictions-profile-warn-3" id="rule-4-restrictions-profile-warn-3"></a>
...
{% step %}
#### Перманентная блокировка <a href="#rule-4-restrictions-profile-ban" id="rule-4-restrictions-profile-ban"></a>
...
{% stepper %}
{% step %}
#### **Первое нарушение:** <a href="#rule-6-restrictions-mute-t-1" id="rule-6-restrictions-mute-t-1"></a>

[<mark style="color:red;">**Мут на 2 дня.**</mark>](https://rules.foxford-community.ru/students#what-is-mute)
{% endstep %}

{% step %}
#### **Массированные упоминания или флуд медиа (первое нарушение):** <a href="#rule-6-restrictions-mute-m-1" id="rule-6-restrictions-mute-m-1"></a>

[<mark style="color:red;">**Мут на 3 дня.**</mark>](https://rules.foxford-community.ru/students#what-is-mute)
{% endstep %}

{% step %}
#### **Повторное нарушение (в течение 7 дней):** <a href="#rule-6-restrictions-mute-tm-2" id="rule-6-restrictions-mute-tm-2"></a>

[<mark style="color:red;">**Мут на 1 неделю.**</mark>](https://app.gitbook.com/s/zxd7yLO3YAw233Y2RBKa/)
{% endstep %}

{% step %}
#### **Систематическое нарушение:** <a href="#rule-6-restrictions-mute-tm-sys" id="rule-6-restrictions-mute-tm-sys"></a>

[<mark style="color:red;">**Предупреждение**</mark>](https://rules.foxford-community.ru/students#what-is-warn) <mark style="color:red;">**и**</mark> [<mark style="color:red;">**мут на 12 дней**</mark>](https://rules.foxford-community.ru/students#what-is-mute)<mark style="color:red;">**.**</mark>
{% endstep %}
{% endstepper %}
...
{% stepper %}
{% step %}
#### **Первое нарушение:** <a href="#rule-6-restrictions-r-mute-1" id="rule-6-restrictions-r-mute-1"></a>

[<mark style="color:red;">**Мут на 1 день.**</mark>](https://rules.foxford-community.ru/students#what-is-mute)
{% endstep %}

{% step %}
#### **Систематическое нарушение:** <a href="#rule-6-restrictions-mute-r-sys" id="rule-6-restrictions-mute-r-sys"></a>

[<mark style="color:red;">**Предупреждение**</mark>](https://rules.foxford-community.ru/students#what-is-warn) <mark style="color:red;">**и**</mark> [<mark style="color:red;">**мут на 2 дня**</mark>](https://rules.foxford-community.ru/students#what-is-mute)**.**
{% endstep %}
{% endstepper %}
...
## 7️⃣ Caps Lock <a href="#rule-7" id="rule-7"></a>

Использование Caps Lock разрешено, но при этом важно соблюдать нормы коммуникации, чтобы сообщение не воспринималось как спам.

Помните, что существует множество способов выражения эмоций без применения Caps Lock, такие как выделение текста жирным шрифтом, курсивом, использование эмоджи😉 и стикеров.

<details>

<summary>Пример нарушений Caps Lock:</summary>

![Пример сообщения наущающего правило Caps Lock](.gitbook/assets/image.png) <- Пример сообщения наущающего правило.

![Второй пример сообщения наущающего правило Caps Lock](<.gitbook/assets/image (1).png>)<- Тоже пример.

</details>

### Наказания: <a href="#rule-7-restrictions" id="rule-7-restrictions"></a>

❗️ За нарушение любого из этих правил выдается <mark style="color:red;">**МУТ НА 2 ДНЯ**</mark>.

***

## 8️⃣ Боты с функцией VIA\_BOT <a href="#rule-8" id="rule-8"></a>

Использование ботов с поддержкой функции via\_bot, или, проще говоря, использование ботов, которые не требуют приглашения или добавления в группу без предварительного одобрения, строго запрещено.

{% hint style="success" %}
**Исключение составляет случай, если&#x20;**<mark style="color:green;">**бот был одобрен**</mark>**&#x20;администрацией.**
{% endhint %}

<details>

<summary><mark style="color:green;"><strong>Список одобренных ботов:</strong></mark></summary>

<mark style="color:green;">**Полностью одобрены:**</mark>

[VIA](https://t.me/VIA_by_VOLT_BOT)

<mark style="color:orange;">**Одобрены в использовании в рамках правил:**</mark>
...
[PlayDeck](https://t.me/playdeckbot)

</details>

### Наказания: <a href="#rule-8-restrictions" id="rule-8-restrictions"></a>

❗ За нарушение любого из этих правил выдается <mark style="color:red;">**ПРЕДУПРЕЖДЕНИЕ**</mark> _(пять предупреждений приводят к <mark style="color:red;">**бану навсегда**</mark>)._
